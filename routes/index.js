...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Electricity App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Electricity App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Electricity App Login', user : req.user }); 
}); 
